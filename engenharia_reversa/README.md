...
![Dashboard principal do sistema](http://googleusercontent.com/image_generation_content/0)
...
- ✅ **Visualização de Clusters:** implementação de gráficos que mostram como o sistema agrupa filmes por afinidade.
- ✅ Melhor entendimento sobre sistemas de recomendação e análise de comportamento do usuário.
...
- Análise de avaliações de usuários
- Visualização gráfica de similaridades
...
Durante o desenvolvimento do projeto, foram desenvolvidas habilidades em:

- Machine Learning aplicado a recomendação
- Tratamento e análise de dados
- Engenharia de atributos
- Visualização de dados
- Uso de bibliotecas Python para IA

---

## 👨‍💻 Autor

Desenvolvido por **Davi Melo Salgueiro Leonardi**  
Disciplina: **Inteligência Artificial (2024.1)**
